  ...
  return (
    <PublicShell locale={locale}>
      <article className="container-zyrix py-12 md:py-16 max-w-3xl">
        ...
        {/* Intro */}
        <div className="prose-like mb-8 p-6 rounded-2xl bg-bg-card border border-line-soft">
        ...
        <div className="space-y-10">
          ...
          <Section title={t("s10.title")}>
            <p>{t("s10.p1")}</p>
            <div className="not-prose rounded-xl bg-primary-50 border border-primary-100 p-5 mt-4">
