      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-cyan-300 text-xs font-bold uppercase tracking-widest mb-2">NOTIFICATIONS</p>
...
function NotificationListRow({
  ...
  return (
    <div
      className={`group flex items-start gap-3 p-4 cursor-pointer hover:bg-muted/40 ${
        unread ? "bg-muted/20" : ""
      }`}
      onClick={onClick}
    >
      ...
      <button
        ...
        className="opacity-0 group-hover:opacity-100 w-7 h-7 rounded text-muted-foreground hover:text-rose-300 hover:bg-rose-500/10 flex items-center justify-center transition-opacity"
      >
