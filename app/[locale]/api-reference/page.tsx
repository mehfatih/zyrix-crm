      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          ...
          <CalloutCard
            ...
            title={t.rateLimit}
            body={<span className="text-xs text-slate-600">{t.rateLimitDesc}</span>}
            color="amber"
          />
        </div>
            ...
            <div key={idx}>
              ...
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                {cat.items.map((ep, i) => (
                  <div
                    key={i}
                    className="px-5 py-3 border-b last:border-b-0 border-slate-100 hover:bg-slate-50/50 flex items-center gap-3 flex-wrap"
                  >
                    <span
                    ...
                    <code className="text-sm font-mono text-slate-800 flex-1 min-w-0">
                      {ep.path}
                    </code>
                    <span className="text-xs text-slate-500 w-full md:w-auto md:max-w-sm">
                      {ep.desc[L]}
                    </span>
                    {ep.auth && (
