...
export default function BulkActionBar({
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 max-w-3xl w-full px-4">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {users.length > 0 && (
            <div className="relative">
              ...
              {showOwnerMenu && (
                <div className="absolute bottom-full mb-1 ltr:left-0 rtl:right-0 bg-white border border-slate-200 rounded-lg shadow-lg py-1 min-w-[200px] max-h-64 overflow-y-auto">
                  {users.map((u) => (
                    <button
                      key={u.id}
          ...
          {entityType === "customers" && (
            <div className="relative">
              ...
              {showStatusMenu && (
                <div className="absolute bottom-full mb-1 ltr:left-0 rtl:right-0 bg-white border border-slate-200 rounded-lg shadow-lg py-1 min-w-[150px]">
                  {statusOptions.map((s) => (
                    <button
                      key={s}
          ...
          {entityType === "customers" && tags.length > 0 && (
            <div className="relative">
              ...
              {showTagMenu && (
                <div className="absolute bottom-full mb-1 ltr:left-0 rtl:right-0 bg-white border border-slate-200 rounded-lg shadow-lg py-1 min-w-[180px] max-h-64 overflow-y-auto">
                  {tags.map((tag) => (
                    <button
                      key={tag.id}
      ...
      {confirmDelete && (
        <div className="mt-2 bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium text-slate-700 bg-white hover:bg-slate-50 rounded-lg"
          >
            {t("cancel")}
          </button>
          <button
