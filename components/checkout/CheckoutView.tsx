      ...
      <div className="w-full max-w-md bg-card rounded-2xl shadow-xl border border-border p-8">
        ...
        {status === "redirecting" && (
          <div className="text-center py-8">
            <Loader2
              size={32}
              className="animate-spin text-cyan-300 mx-auto mb-3"
            />
        ...
        {status === "need_signup" && (
          <div className="text-center py-4">
            <div className="inline-flex items-center gap-2 rounded-lg bg-amber-500/10 text-amber-800 px-3 py-2 text-sm font-medium mb-4 ring-1 ring-amber-500/30">
              <AlertCircle size={16} />
              {t("needSignup")}
            </div>
            ...
            <Link
              href={signupHref}
              className="inline-flex items-center justify-center w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg px-4 py-2.5 text-sm font-semibold"
            >
              {t("continueToSignup")}
            </Link>
        ...
        {status === "error" && (
          <div className="py-4">
            <div className="rounded-lg bg-rose-500/10 border border-rose-500/30 p-4 text-sm text-red-800 mb-4">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => router.back()}
                className="flex-1 rounded-lg border border-border hover:bg-muted text-foreground px-4 py-2.5 text-sm font-semibold"
              >
                {t("goBack")}
              </button>
              <Link
