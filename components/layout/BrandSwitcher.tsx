  ...
  return (
    <div className="relative">
      <button
        ref={triggerRef}
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-sky-50 border border-sky-100 bg-white max-w-40"
      ...
      {open && (
        <div
          ...
          } w-64 rounded-xl border border-sky-100 bg-white shadow-xl overflow-hidden z-50`}
          dir={isRtl ? "rtl" : "ltr"}
        >
          <div className="p-2 border-b border-sky-50">
            <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wide px-2 pt-1 pb-0.5">
              ...
              .map((b) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <code className="text-[10px] text-slate-500 font-mono" dir="ltr">
                      {b.slug}
                    </code>
                  </div>
                  {activeBrandId === b.id && (
          ...
          <div className="p-1 border-t border-sky-50 bg-sky-50/30">
            <Link
