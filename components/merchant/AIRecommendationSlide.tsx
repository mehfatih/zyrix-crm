...
export function AIRecommendationSlide({
  ...
  const content = (
    <div className="w-full h-full flex items-center gap-5 px-6">
      ...
      <span
        className="hidden sm:inline-flex items-center gap-1.5 h-9 px-4 rounded-full bg-white text-cyan-700 text-sm font-semibold shadow-sm hover:shadow-md transition-shadow flex-shrink-0"
      >
        {ctaLabel}
        {ArrowIcon}
      </span>
