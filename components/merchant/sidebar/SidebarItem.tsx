      ...
      >
        ...
        <Icon
          className={`w-[18px] h-[18px] flex-shrink-0 ${
            active ? "text-cyan-300" : "text-muted-foreground group-hover:text-foreground"
          }`}
        />
        ...
        <button
          ...
          className={`absolute top-1/2 -translate-y-1/2 ltr:right-1 rtl:left-1 w-6 h-6 rounded-md items-center justify-center transition-opacity ${
            pinned
              ...
              : "hidden group-hover:flex text-muted-foreground hover:text-cyan-300 hover:bg-muted"
          }`}
        >
