      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 z-50 h-full w-full max-w-[420px] bg-card shadow-2xl border-l border-border flex flex-col"
          >
            <header className="flex items-center justify-between border-b border-border bg-gradient-to-br from-zyrix-aiSurface to-white px-6 py-4">
              <div className="flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-r from-primary to-violet-500">
...
function ContextSection({
  ...
  return (
    <section className="rounded-xl border border-border bg-card p-4 hover:shadow-md transition-shadow">
      ...
      {cta && (
        <button className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-primary to-violet-500 px-3 py-1.5 text-xs font-bold text-white hover:opacity-90">
          {cta}
        </button>
      )}
    </section>
